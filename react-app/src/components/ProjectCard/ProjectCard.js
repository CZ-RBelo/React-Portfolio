        ...
        <div className="row">
            <div className="card border-0 rounded-0 mb-5" style={{ backgroundColor: '#f8f8f8' }}>
                ...
                <div className="card-body">
                    ...
                    <a href={props.deployed} target="_blank" rel="noreferrer" className="btn btn-secondary btn-sm  ms-3">Web page link</a >
                    <a href={props.github} target="_blank" rel="noreferrer" className="btn btn-secondary btn-sm ms-1">Github link</a >
                </div>
            </div>
        </div>
    )
